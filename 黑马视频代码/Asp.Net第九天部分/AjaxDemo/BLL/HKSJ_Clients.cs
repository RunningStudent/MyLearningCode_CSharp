...
namespace News.BLL
{
	...
	{
		private readonly News.DAL.HKSJ_Clients dal=new News.DAL.HKSJ_Clients();
		public HKSJ_Clients()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(News.Model.HKSJ_Clients model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(News.Model.HKSJ_Clients model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public News.Model.HKSJ_Clients GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public News.Model.HKSJ_Clients GetModelByCache(int id)
		{
			...
			return (News.Model.HKSJ_Clients)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Clients> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Clients> DataTableToList(DataTable dt)
		{
			List<News.Model.HKSJ_Clients> modelList = new List<News.Model.HKSJ_Clients>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				News.Model.HKSJ_Clients model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new News.Model.HKSJ_Clients();
