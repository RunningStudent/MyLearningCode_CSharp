...
namespace News.BLL
{
	...
	{
		private readonly News.DAL.HKSJ_Main dal=new News.DAL.HKSJ_Main();
		public HKSJ_Main()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public News.Model.HKSJ_Main GetModelByCache(int ID)
		{
			...
			return (News.Model.HKSJ_Main)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Main> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Main> DataTableToList(DataTable dt)
		{
			List<News.Model.HKSJ_Main> modelList = new List<News.Model.HKSJ_Main>();
        ...
        /// <param name="totalListCount">数据总条数</param>
        /// <returns></returns>
        public List<Model.HKSJ_Main> MyGetListByPage(int pageSize, int pageIndex, out int totalListCount)
        {
            return dal.MyGetListByPage(pageSize, pageIndex, out totalListCount);
        }
    }
}
