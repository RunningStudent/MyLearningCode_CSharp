...
namespace News.BLL
{
	...
	{
		private readonly News.DAL.HKSJ_Relationship dal=new News.DAL.HKSJ_Relationship();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(News.Model.HKSJ_Relationship model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public News.Model.HKSJ_Relationship GetModel(int ID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public News.Model.HKSJ_Relationship GetModelByCache(int ID)
		{
			...
			return (News.Model.HKSJ_Relationship)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Relationship> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_Relationship> DataTableToList(DataTable dt)
		{
			List<News.Model.HKSJ_Relationship> modelList = new List<News.Model.HKSJ_Relationship>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				News.Model.HKSJ_Relationship model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new News.Model.HKSJ_Relationship();
