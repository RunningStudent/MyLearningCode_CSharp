...
namespace News.BLL
{
	...
	{
		private readonly News.DAL.HKSJ_USERS dal=new News.DAL.HKSJ_USERS();
		public HKSJ_USERS()
		{}
		#region  Method
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(News.Model.HKSJ_USERS model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public News.Model.HKSJ_USERS GetModel(int ID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public News.Model.HKSJ_USERS GetModelByCache(int ID)
		{
			...
			return (News.Model.HKSJ_USERS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_USERS> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<News.Model.HKSJ_USERS> DataTableToList(DataTable dt)
		{
			List<News.Model.HKSJ_USERS> modelList = new List<News.Model.HKSJ_USERS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				News.Model.HKSJ_USERS model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new News.Model.HKSJ_USERS();
