<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowDetailForm.aspx.cs" Inherits="News.Web.MyCRUD.ShowDetailForm" %>
...
<link href="../MyContent/style/style.css" rel="stylesheet" type="text/css" />
</head>
<body class="body_column">
<form id="form1" runat="server">
	<div id="wrap_column">
       <!----------------------------------begin header_column---------------------------------->
       <div id="header_column" class="header_news"><!-- #BeginLibraryItem "/Library/header.lbi" --><h1 class="logo_column"><a href="../index.html"><img src="../MyContent/images/logo.png" width="179" height="55" alt="北京华科世佳软件开发有限公司" /></a></h1>
         
<!-- #EndLibraryItem -->
<div class="nav_column">
         <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="754" height="37" id="FlashID" title="北京华科世佳软件开发有限公司">
           <param name="movie" value="../MyContent/flash/sub_fla.swf" />
           <param name="quality" value="high" />
           <param name="wmode" value="transparent" />
           <param name="swfversion" value="8.0.35.0" />
           <!-- 此 param 标签提示使用 Flash Player 6.0 r65 和更高版本的用户下载最新版本的 Flash Player。如果您不想让用户看到该提示，请将其删除。 -->
           <param name="expressinstall" value="../MyContent/flash/sub_fla.swf" />
           <!-- 下一个对象标签用于非 IE 浏览器。所以使用 IECC 将其从 IE 隐藏。 -->
           <!--[if !IE]>-->
           <object type="application/x-shockwave-flash" data="../MyContent/flash/sub_fla.swf             
" width="754" height="37">
             <!--<![endif]-->
             <param name="quality" value="high" />
             <param name="wmode" value="transparent" />
...
<!----------------------------------end header_column---------------------------------->
	  ...
	  <div id="main_column">
        ...
        <dl class="menu_prd">
            ...
            <a href="../Contact/Contact.html" class="contct"><img src="../MyContent/images/img_contact_sidebarcolumn.png" width="160" height="52" alt="联系我们" /></a><!-- #EndLibraryItem --></div>
      	<div id="content_column">
            ...
            <div class="cont">
           	  <h1 class="title"><%=NewsDeatail.title %></h1>
              <p class="info"><%=NewsDeatail.Date.ToString() %></p>
                <%=NewsDeatail.content %>
          </div>
        </div>
      	<div class="clear"></div>
